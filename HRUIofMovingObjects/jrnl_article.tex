...
\title{Capon Adaptive Beamforming Applied on Moving Objects - An Analysis of Local Shift Invariance}
%
%
...
\author{J. P. \AA{}sen, C.-I. C. Nilsen, A. Austeng and S. Holm%\IEEEmembership{Member,~IEEE,}% <-this % stops a space
...
\section{Temporal Artifacts}

\section{Causes}\label{sec:meth}
   
\subsection{Local Shift Variance}

\section{Cures}

\subsection{Multiple Parallel Recieve Lines}
