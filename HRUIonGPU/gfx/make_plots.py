...
bar('timer_values_M=64_Nx=80_Ny=606_L=2-32.txt', 64, 80, 606, 2, 32)

#barBS('timer_values_M=64_Nx=80_Ny=606_L=16-48_Nb=3.txt', 64, 3, 80, 606, 16, 47)
#barBS('timer_values_M=96_Nx=120_Ny=606_L=24-72_Nb=3.txt', 96, 3, 120, 606, 24, 71)
