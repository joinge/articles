...
bar('timer_values_M=96_Nx=120_Ny=540_L=2-48.txt', 96, 120, 540, 2, 48, 2)

#barBS('timer_values_M=64_Nx=80_Ny=540_L=16-48_Nb=3.txt', 64, 3, 80, 540, 16, 47, False)
#barBS('timer_values_M=96_Nx=120_Ny=540_L=24-72_Nb=3.txt', 96, 3, 120, 540, 24, 71)
