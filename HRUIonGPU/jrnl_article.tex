...
\label{fig:benchBS5}}}
\caption{Benchmark of GPU beamspace Capon beamforming for a cardiac image covering a $70 \degree$ and $15$cm deep sector. Execution time is plotted as a function of subarray length $L$. (a) Shows the benchmark for a 64 elements array. (b) Shows the benchmark for a 96 elements array. (TODO: Change this to be a function of $N_b$)}
\label{fig:benchBS}
\end{figure*}
