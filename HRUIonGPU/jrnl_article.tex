...
The adaptive weights are therefore found by solving the following minimization problem:
\begin{align}
...
Finally we calculate the beamformer output by combining the results from all subarrays.
\begin{align}
z[n] = \sum_{l=0}^{l=N_L-1} .
\end{align}
