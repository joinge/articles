...
\title{Implementing Capon Adaptive Beamforming on the GPU for Real Time Ultrasound Imaging}
%
%
...
{\AA{}sen \MakeLowercase{\textit{et al.}}: Implementing Capon Adaptive Beamforming on the GPU for Real Time Ultrasound Imaging}
...
\begin{IEEEkeywords}
Adaptive beamforming, Capon beamformer, Graphics Processing Unit, Parallel Computing, Ultrasound Imaging.
\end{IEEEkeywords}
