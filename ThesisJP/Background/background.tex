...
\end{align}
where \nom{$\vec{w}$}{Array weight vector (apodization)} is know as the array \textit{weight vector} or \textit{apodization}, and $z[n]$ is the output A-mode image in the direction dictated by $\Delta_m[n]$.  If $p_o$ is the phase center of our array and $p$ is the point where we want to steer and focus the ultrasound beam, we have to use the following delays:
\begin{align}
