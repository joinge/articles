...
\end{align}
If our cardiac probe has $M=128$ elements, DAS beamforming requires a processing throughput of around $350$ MFLOPS. Hence, far below the peak processing throughput of modern GPUs and CPUs.
