...
\includegraphics[width=0.8\linewidth]{gfx/beamforming.eps}
\fi%
...
\else
\begin{figure}[!t]\centering
\includegraphics[width=.9\linewidth]{gfx/implementation.eps}
\fi%
...
\else
\begin{figure}[!t]\centering
\includegraphics[width=.9\linewidth]{gfx/mvdr_complexity.eps}
\fi%
...
\else
\begin{figure}[t]\centering
\includegraphics[width=.9\linewidth]{gfx/mvdr_build_R.eps}
\fi%
...
\else
\begin{figure}[!t]\centering
\includegraphics[width=.9\linewidth]{gfx/buildR-breakdown.eps}
\fi%
...
\else
\begin{figure}[!t]\centering
\includegraphics[width=.9\linewidth]{gfx/mvdr_implementation.eps}
\fi%
...
\ifPeerReview\else
\begin{figure}[!t]\centering
\includegraphics[width=.9\linewidth]{gfx/plot_holmengraa_L16_Navg1.eps}
...
\ifPeerReview\else
\begin{figure}[!t]\centering
\includegraphics[width=.9\linewidth]{gfx/code_assessment.eps}
...
\else
\begin{figure}[!t]\centering
\includegraphics[width=.9\linewidth]{gfx/benchmark.eps}
\fi%
...
\else
\begin{figure}[!t]\centering
\includegraphics[width=.9\linewidth]{gfx/code_assess_flops.eps}
\fi
...
\else
\begin{figure}[!t]\centering
\includegraphics[width=.9\linewidth]{gfx/benchmark_boston.eps}
\fi
...
controllers present on modern GPUs. Furthermore, the data rates in active sonar are relatively low compared to the bandwidth available for these transfers. 
% 
...
\subsection{MVDR Complexity Formulas}\label{mvdr_formulas}
...
\subsection{GPU Throughput}\label{throughput}
