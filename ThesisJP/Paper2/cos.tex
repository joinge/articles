...
\begin{figure*}[!t]
\centerline{
\subfloat[]{\includegraphics[width=0.5\textwidth]{gfx/benchmark_bar_64_80_540.png} \label{fig:benchUS64}}\\
\hfil
\subfloat[]{\includegraphics[width=0.5\textwidth]{gfx/benchmark_bar_96_120_540.png}%
\label{fig:benchUS96}}}
...
\begin{figure*}[!t]
\centerline{\subfloat[]{\includegraphics[width=0.5\textwidth]{gfx/benchmark_bar_bs_M=64_Nx=80_Ny=540_Nb=3.png} \label{fig:benchBS64}}
\hfil
\subfloat[]{\includegraphics[width=0.5\textwidth]{gfx/benchmark_bar_bs_M=96_Nx=120_Ny=540_Nb=3.png}%
\label{fig:benchBS96}}}
...
\begin{figure*}[!t]
\centerline{
\subfloat[]{\includegraphics[width=0.3\textwidth]{gfx/das_invivo.png} \label{fig:invivoDAS}}
\hfil
\subfloat[]{\includegraphics[width=0.3\textwidth]{gfx/capon_invivo.png} \label{fig:invivoMV}}
\hfil
\subfloat[]{
\includegraphics[width=0.3\textwidth]{gfx/capon_bs_invivo.png} \label{fig:invivoBS}}
\hfil
\includegraphics[height=0.3\textwidth]{gfx/colorBarInvivo2.png}
}
