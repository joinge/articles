...
%
\begin{abstract}
In active sonar imaging one is typically concerned with extracting intensity and phase information from a backscattered acoustic wavefield. Usually an image that 
...
In a common active sonar scenario one employ phased arrays to record the

In active sonar imaging one is typically concerned with creating images containing intensity and phase information of the imaged scene. To improve the resolution and contrast it has been shown that adaptive beamforming methods can be 
