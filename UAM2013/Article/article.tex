...
In active sonar imaging systems the choice of sensor weights will greatly influence image quality. The best results are obtained when the weights are allowed to change to accommodate the dynamic nature of the impinging wavefield. The Minimum Variance Distortionless Response (MVDR) achieves this by computing the set of weights that minimise noise and interference accumulated by the array. 
