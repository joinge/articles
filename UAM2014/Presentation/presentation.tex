...
\flushright\hspace{-10pt}\graphicsAI[drawing,width=.92\linewidth]{gfx/rock_formation.svg}
\end{narrow}
\end{figure}
\vspace{-10pt}
...
% {
% \setbeamertemplate{background}{%
% \graphicsAI[drawing,width=\paperwidth]{gfx/background.svg}}%
\begin{frame}
\frametitle{Results}
...
% - Probably(?) not needed: Noise, speckle, beam pattern, multipath, penetration
