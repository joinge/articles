...
To obtain the delayed real-time performance we implemented the simulator on a GPU. These devices have a theoretical peak performance that is typically an order of magnitude higher than CPUs in a comparable price range. We experienced that this potential was effectively utilized with a well matured and highly optimized graphics processing API such as OpenGL. Our simulator use this framework for most of the scene processing.
