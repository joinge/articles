...
To produce the sonar templates we assume rough, isotropic surface that reflects energy equally in all directions. This well with a Lambertian scattering model where the backscatter intensity depends only on the angle between the incident angle and surface normal.  
...
\begin{itemize}
\item Lambertian surface scattering model. Rough, isotropic, reflects energy equally in all directions. Intensity depends only on the angle between the look direction and surface normal.
\item 
\end{itemize}
