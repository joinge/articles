...
\caption{Method relations. This thesis explores three beamformers reconstructing images from acoustic echoes: time-domain MVDR (reference), frequency-domain MVDR (close approximation) and time-domain LCA (educated trial-and-error). Background on synthesis of image templates from the reconstructed images is presented in article IV. }
\end{figure}
