...
Biological creatures sense and react to waves almost instantaneously, adapting their behavior on-the-fly to survive, filling in knowledge gaps, satisfying their curiosity, or honing a skill. Such traits help them master the world, but seem notoriously hard to grant machines.
...
Technology substitutes biology's finesse with brute force: throwing superior sensors and massive computing power at the problem, but failing to replicate biology's intricate information processing. Computers never tire, hardly fail, handle information relentlessly at high bandwidth and low latency, and communicate extremely fast---but they lack the ability to truly adapt, learn, be curious and ask the question ``Why?''
