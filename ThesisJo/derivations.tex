...
%
\begin{align}
\w = e^{j\phi_\theta[m]}\big(\alpha - (1-\alpha)\sin\left(\frac{2\pi m}{M-1}\right)\big)
\end{align}
%
...
%
\begin{align}
a = \sumb{m=0}{M-1} e^{j\phi_\theta[m]} \qquad \text{and} \qquad b_m = \sumb{m=0}{M-1} e^{j\phi_\theta[m]}\sin\left(\frac{2\pi m}{M-1}\right)
\end{align}
%
