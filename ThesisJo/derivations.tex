...
\begin{align}
\text{Equivalent Noise Bandwidth} &= \frac{\text{Noise Power}}{\text{Coherent Power Gain}} = \frac{N_0\sumb{m}{}w_m^2}{\big|\sumb{m}{}w_m\big|^2}
\end{align}
...
\begin{align}
\text{Scallopping loss} &= \frac{\left|W\left(\frac{\pi}{2OMd}\right)\right|}{W(0)} = \frac{\left|\sumb{m}{}w_m\;e^{-j\k\cdot\p_m}\right|}{\sumb{m}{}w_m}
\end{align}
