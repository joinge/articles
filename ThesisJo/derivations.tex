...
Instead of solving the wave equation directly, we will make a qualified guess that the solution takes the form of a complex exponential:
%
\begin{align}
s(\p,t) &= A\,e^{j(\omega t - \k\dot\p)}
\end{align}
%
