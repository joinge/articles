...
\end{align}
%
This is called the homogeneous lossless wave equation, because there is no source term. When our signal $s$ signifies pressure (N/m$^2$), this links time and space by means of mass flow rate (kg/(m$^3$s). The inhomogeneous equation can be obtained in a similar way, by altering the linearized continuity equation to include a source:
%
\begin{align}
