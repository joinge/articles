...
\end{align}
%
An additional constraint we may surely apply is the Euler's equation, a modification of Newton's second law:
%
\begin{align}
\frac{F}{dV} = \frac{m}{dV} a = \rho\Big(\frac{\partial\v}{\partial t} + \nabla\v\Big) = -\nabla p.
\end{align}
%
