...
\end{align}
%
Next, an \textbf{equation of state} is needed to relate a change in density to a change in pressure. We assume our volume element to be isentropic, i.e. that the entropy is constant, or equivalently that total energy of the system is proportional to its temperature. This is true for any system that is reversible and adiabatic, i.e. that when no transfer of matter or heat occurs between the system and its surroundings. In other words, we assume the system to be \emph{loss-less} system. In reality a passing sound wave will heat the fluid and add to the entropy, ultimately leading to additional attenuation of the wave, but we will not deal with this topic in this thesis.

The pressure of the system then just depends on the mass density:
%
\begin{align}
p = p(\rho)
\end{align}
