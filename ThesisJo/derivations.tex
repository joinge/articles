...
We begin by defining the mass flow in and out of a volumetric element $dV = dx dy dz$:

\begin{align}
\dot m_\text{in} = \rho\,\v\,dV \qquad\qquad \text{and} \qquad\qquad \dot m_\text{out} = \rho\,\v\,dV + 
\end{align}
