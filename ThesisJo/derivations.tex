...
\begin{align}
\argmin{\w}{E\big\{||\w\H\x||^2\big\}} \qquad\text{subject to }\w\H\a = 1
\end{align}
%
\begin{align}
\argmin{\w}{E\big\{||\w\H\x||^2\big\}} 
&= \argmin{\w}{E\big\{\big(\w\H\x\big)\big(\w\H\x\big)^*\big\}} \nn
&= \argmin{\w}{\w\H E\big\{\x\x\H\big\}\w\H} \nn
&= \argmin{\w}{\w\H\R\w\H}
\end{align}
%
