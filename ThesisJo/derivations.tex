...
We begin by defining the net mass flow in and out of a volumetric element $dV = dx dy dz$:

\begin{align}
\dot m_\text{net} = \Big(\frac{\partial \rho\,\v}{\partial x} + \frac{\partial \rho\,\v}{\partial y} + \frac{\partial \rho\,\v}{\partial z} \Big) dV = \nabla \cdot (\rho\v)\, dV
\end{align}
