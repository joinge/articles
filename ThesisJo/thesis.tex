...
\else
   \cleardoublepage
   \includepdf[pagecommand={\thispagestyle{plain}}, pages=1]{build/2_mvdr.pdf}
   \includepdf[pagecommand={\thispagestyle{empty}}, pages=2]{build/2_mvdr.pdf}
   \includepdf[pagecommand={\thispagestyle{plain}}, pages=3-]{build/2_mvdr.pdf} 
\fi
