...
For all intents and purposes in this thesis the coordinate system shown in \Fig{geometry} will be used. A a unit length vector 

\begin{figure}[th]
\graphicsAI[drawing,width=.5\linewidth]{gfx/geometry.svg}\label{geometry}
\end{figure}
