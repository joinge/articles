...
\IEEEPARstart{O}{ne} of the greatest visions in science is that of artificial intelligence. If we could make machines not only do what we say, but also able to adapt their behaviour to handle the unexpected, the possibilities are perhaps only limited by our imagination.
