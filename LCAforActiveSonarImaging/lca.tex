...
In the image reconstruction we have run MVDR with subarray length $L=16$ and $d=1\%$ diagonal loading\todo{also used for element distance}. Both MVDR and LCA was run with $K=1$ temporal averaging. This is a fairly aggressive yet stable set of parameters.\todo{suitable ref?}
