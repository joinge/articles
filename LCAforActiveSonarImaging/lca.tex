...
\IEEEPARstart{T}{o} form images from a modern phased array sonar system the received waveform is usually recorded, and then processed by a digital beamformer. Estimating one pixel at a time, the beamformer adjusts the arrays spatial response to ensure the maximum gain in the direction of the pixel of interest, while maintaining maximum suppression at all other angles. 
...
\item LCA is like DAS, only we test several windows and choose the one that yield the lowest beamformer output power. Ultrasound \cite{Synnevag2008}, active sonar \cite{Buskenes2011}\cite{Blomberg2011}\cite{Blomberg2012}
