...
\end{align}
%
where $\a$ is a steering vector and $\R[n] = E\{\x\x\H\}$ is the spatial covariance matrix. This is a convex optimization problem with the solution:
%
\begin{gather}
...
From a set of $P$ windows the LCA beamformer selects the window $p$ that yields the least output power:
%
\begin{align}
\underset{p}{\argmin}\, E\{|z[n]|^2\} = \underset{p}{\argmin}\, E\big\{|\w_p\H\x[n]|^2\big\}\\
