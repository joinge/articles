...
\includegraphics[width=\linewidth]{gfx/mvdr_selected_windows_holmengraa.eps}%
...
\begin{figure*}[t]%\centering%
\includegraphics[width=\textwidth]{gfx/oversampling_mosaic_bounds_lca_windows_beta.eps}%
\caption{Window parameter boundaries. Oversampled image, 19x20 windows.}\label{oversampling_mosaic_bounds_beta}
\end{figure*}

\begin{figure*}[t]%\centering%
\includegraphics[width=\textwidth]{gfx/oversampling_mosaic_bounds.eps}%
...
\begin{figure*}[t]%\centering%
\includegraphics[width=\textwidth]{gfx/oversampling_mosaic.eps}%
