...
\item \emph{Window parameters}. The Kaiser window parameter $\beta$ tunes the compromise between resolution and sidelobe suppression. At $\beta=0$ ) and a gaussian curve (
\end{itemize}
...
\newpage
\begin{figure*}[tbhp!]%\centering%
\includegraphics[width=.5\textwidth]{gfx/oversampling_mosaic_bounds_lca_windows_beta.pdf}%
