...
\end{align}
%
This is true for any value of $\alpha$ if $\a_\phi\T\1 = 1$ and $\b_\phi\T\1 = 1$. Hence, we can preserve the unity gain constraint as long as we normalize $\a$ and $\b$.

Now let $a=\a\T\x$ and $b=\b\T\x$. The beamformer output can then be written as:
%
\begin{align}
|\w\H\x|^2 &= \Big| \alpha a - (1-\alpha)b \Big|^2 \nn
&= \alpha^2 (aa^* + ab^* + a^*b - bb^*) - \alpha(ab^* + a^*b + 2bb^*) + bb^*
\end{align}
%
