...
\emph{Right:}\hfill
\parbox[t]{.95\linewidth}{Window responses computed from 40x40 pixel groups in the shadow, highlight and speckle region of the Holmengraa image. The dashed red lines at -13dB and -43dB marks the peak sidelobe levels of a rectangular and Hamming window, respectively. Note how the responses are more or less symmetric, with very little steering in the shadow, moderate steering in speckle and steering within roughly 3dB in highlight. The phase varies mostly in highlight.} }\label{mvdr_selected_windows}
\end{figure*}
