...
\mbox{}\hfill\parbox[t]{.95\linewidth}{\emph{Goal: Determining LCA window type.}}
\newline
\emph{Left:}\hfill
...
%
\begin{align}
E\big\{|z_p[x,n]|^2\big\} = \frac{1}{N_x N_k} \sumb{x'=x-X}{x+X} \sumb{n=n-K}{n+K} w_\text{prf}[x',n']\big| z_p[x',n'] \big|^2
\end{align}
%
