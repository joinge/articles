...
In this work we apply the LCA method to data from the Kongsberg Maritime HISAS 1030 synthetic aperture sonar (SAS). It has 32 sensors, operates at 100\,kHz and an opening angle of 25$^\circ$. We focus on using LCA with variations of the parametric Kaiser window, but a comparison to using trigonometric windows will also be provided. Unlike Synnev\aa{}g we steer all our windows and not just some, and elaborate on the type of Kaiser windows to include and the method of steering. 
