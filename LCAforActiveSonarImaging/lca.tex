...
This article is outlined as follows: In section \ref{beamforming} we introduce beamforming, \ref{mvdr} MVDR \ref{lca} LCA \ref{} \ref{} \ref{}
...
\newpage
\subsection{Receive Beamforming}\label{beamforming}
