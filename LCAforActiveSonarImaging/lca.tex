...
\caption{\emph{Determining LCA window type}: MVDR images with typical frequency responses for windows used in various pixel regions.\newline
\emph{Left:}\hfill
...
The total window database we will construct will contain $N_\beta$ Kaiser windows with different $\beta$-values, each being steered in $N_\phi$ different directions. Hence, the total window size will be $N_w = N_\beta N_\phi$.
