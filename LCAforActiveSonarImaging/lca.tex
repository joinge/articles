...
\begin{figure*}[t]\centering
\subfloat[]{\includegraphics[width=\textwidth]{gfx/beamformer_comparison_holmengraa.pdf}%%
\label{oversampling_mosaic_bounds_beta}}
\hfil
\subfloat[]{\includegraphics[width=\textwidth]{gfx/beamformer_comparison_cross.pdf}%
\label{oversampling_mosaic_bounds_phi}}
\caption{}\label{fig_sim}
\end{figure*}
