...
\end{align}
%
Here $d$ is the element spacing and $\lambda$ is the wavelength. The normalization factor $\f_\beta\H\a_\phi$ is the reciprocal of the window's coherent gain. It is needed to ensures unit gain in the direction of interest as required by (\ref{eq_lca_constraint}). Since the signal-to-noise gain is constant for a given window, this normalization also proportionally increases the  incoherent noise gain.
