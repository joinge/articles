...
A beamformer is a spatial filter we apply to backscattered wavefield data to perform e.g. source localization and amplitude estimation. In sonar image reconstruction we desire 
