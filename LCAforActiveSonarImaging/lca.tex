...
\caption{The cross and accompanying anchor used to test the beamformers.}\label{windows_steering}
\end{figure}
...
Adding slightly steered versions of each window to the window database gives LCA greater flexibility in searching for optimal window. A Kaiser window $\f_\beta$ steered to $\phi$ can be expressed as 
%
\begin{align}
