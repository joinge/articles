...
%
\begin{align}
\underset{p}{\argmin}\, E\{|z_p[n]|^2\} = \underset{p}{\argmin}\, E\big\{|\w_{p}\H\x[n]|^2\big\}\nn
...
%
\begin{align*}
E\big\{|z_p[n]|^2\big\} = \frac{1}{N_k} \sumb{n'=n-K}{n+K} | z_p[n'] |^2
\end{align*}
%
...
%
\begin{align}
E\big\{|z_p[x,n]|^2\big\} = \frac{1}{N_x N_k} \sumb{\nmat{\scriptstyle x'=\\[-2mm]\scriptstyle x-X}}{x+X} \sumb{\nmat{\scriptstyle n'=\\[-2mm]\scriptstyle n-K}}{n+K} w_\text{prf}[x',n']\big| z_p[x',n'] \big|^2\end{align}
%
...
\end{align}
%
where we define the steering vector $\a_\phi$ as:
%
\begin{align}
\a_\phi = \bmat{
1 \\
