...
\ifTODO
   ...
   \usepackage[backgroundcolor=LightBlue]{todonotes}
\else
...
\IEEEPARstart{A}{daptive} beamformers have only recently been introduced in active sonar imaging.\todo[inline]{break} This is because , as demo file is intended to serve as a ``starter file''
