...
\caption{$\beta$-values of the windows LCA selects for each image pixel. The underlying image is the same cross as shown in \Fig{oversampling_mosaic_bounds}. Oversampled image, 19x20 windows.}\label{oversampling_mosaic_bounds_beta}
\end{figure*} 
