...
\section{Steering a Kaiser window}

\begin{align}
w[n] = \begin{cases}
\frac{I_0\left(\pi\beta\sqrt{1-\left(\frac{2\pi}{N-1}-1\right)^2}\right)}{I_0(\pi\beta)}, & 0\le n\le N-1 \\
0 & \text{otherwise}
\end{cases}
\end{align}
...
\begin{figure*}[tbhp!]%\centering%
\includegraphics[width=.4\textwidth]{gfx/oversampling_mosaic_bounds_lca_windows_beta.pdf}%
