...
\end{align}
where $w_m$ is the weight factor assigned to channel $m$. We will refer to a set of weights as a window, but it is also commonly called a taper function. Conventional beamformers all have static weights, and by far the most common of these is the delay-and-sum (DAS) beamformer, which does exactly what the name implies.
