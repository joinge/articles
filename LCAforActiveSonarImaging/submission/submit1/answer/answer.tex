...
\item Reference to Synnevåg's proceedings article from 2008, ``A low-complexity data-dependent beamformer'' replaced with his 2011 journal article with the same name. We never intended to reference the proceedings article since this work extends his journal version.
\end{enumerate}
