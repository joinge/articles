...
\ai{We agree with the reviewer that this should be improved. We still state the two order of magnitude improvement over our reference implementation as this is the total improvement we obtained, but also state that this figure would likely be 5-10 had a similar effort been carried out on the CPU side as well.}
%
\hi{Section I}
