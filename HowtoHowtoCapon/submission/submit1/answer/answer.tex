...
\ai{Thank you for finding these grammatical bugs. Corrections applied.}
%
\hi{Section IV}
...
\ai{We indeed presteer all the elements. TODO}
%
...
\ai{Actually, $\R$ is averaged over $2K+1$ time samples, this can be seen from (4). TODO}
%
