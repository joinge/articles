...
Previous work have shown that the robustness issue can be solved by means such as temporal and spatial averaging~\cite{Kailath1985}, and regularisation. To reduce computational complexity, some studies have demonstrated the feasibility of enforcing a Toeplitz-structure on the covariance matrix to simplify its inversion~\cite{Asl2012a,Jakobsson2000m}, or performing MVDR beamforming in beamspace (frequency domain)~\cite{Nilsen2009}.
