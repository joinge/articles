...
Typical modern active sonar systems use multielement arrays to transmit a known signal towards an object of interest, and record the reflected wavefield. A sonar image may then be formed by coherently combining the receiver outputs in the post-processing to focus on pixels in the image, on at a time. This focusing concept is commonly referred to as beamforming, and involves assigning suitable delays and weights to the array's channels.
