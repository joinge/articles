...
\item $\eR$ computed using the \emph{minimized memory} solution.
...
\item $\eR$ computed using the \emph{minimized instructions} solution. Only upper half of $\eR$ is computed (see next point).
