...
The Minimum Variance Distortionless Response (MVDR) beamformer is a data driven method 

Data driven methods have been reported to improve image quality in various imaging fields over the years. One such method, the , has been 
shown to produce images with improved contrast and resolution compared to conventional non-adaptive methods, in e.g. radar~\cite{Benitz1997}, ultrasound~\cite{Synnevag2007}, and passive sonar. Recently has its feasibility in active sonar also been demonstrated~\cite{Blomberg2012a,Blomberg2011,Dursun2009,Lo2004}.
