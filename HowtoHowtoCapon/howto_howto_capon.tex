...
The \gls{MVDR} beamformer is a high resolution has recently been applied to active sonar imaging. It has recently been applied to active sonar imaging, and shown to offer improved interference suppression and image quality over conventional methods~\cite{Blomberg2012a,Blomberg2011,Dursun2009,Lo2004}

 is an adaptive beamformer  technique. While ensuring unit gain in the look direction, it computes the set of weights that minimizes the power accumulated by the array from other directions. Its ability to suppress interference power and improve image quality in active sonar systems has been demonstrated in e.g.~\cite{Blomberg2012a,Blomberg2011,Dursun2009,Lo2004}.
