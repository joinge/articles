...
determine bandwidth:
case: compute a*b+c, 2 flops, 12 bytes in, 4 bytes out = 8 bytes per flop
at peak 1.3Tflop/s we need 10.4Tflops/s!!! shared is only at 1.3TB/s, registers are atleast x6 as fast on fermi
a factor 6 can be gained by using ilp instead of dlp
