...
\begin{abstract}
Autonomous underwater vehicles (AUVs) hit the unknown like a brick wall: seeing but not perceiving it. They lack intuition, experience, curiosity and understanding to do so. We can tell them what to expect, but only for a select few scenarios. This, of course, is hardly an ideal strategy.
