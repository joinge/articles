...
%
\begin{itemize}
\item \emph{Below 20\% FPR} the adaptive techniques outperforms the static method in every run. This benefits e.g. mine counter measures (MCM) operations where only a few detections out of 3000 will be visually inspected up close.
...
ROC plots FPR vs TPR, false alarm vs hit rate, 
