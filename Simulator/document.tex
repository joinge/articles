...
%
where $:=$ is an assignment operator. The two last lines mitigate round-off artifacts by distributing the intensity value linearly between the two neighboring cells of a range value.  
