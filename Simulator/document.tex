...
%
\figstep{5}{\emph{Normalization of coordinates}. OpenGL only renders coordinates that fall in the range $[-1,1]$. We map valid range for along-track, range and elevation (marked with \checkicon) into this normalized range with a \emph{normalization matrix} $\mat{T}_\textit{\tiny\!NR}$.
}\\[.5\baselineskip]
%
...
\todo{Cherie: New caption text in Fig. 4. What do you think?}
