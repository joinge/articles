...
\subfloat[Best template out of a predefined set. Inaccurate cylinder length, alignment and immersion depth. The segmented shadow and highlight regions are misaligned.\label{overlay_cylinder}]{
\graphicsAI[drawing,width=.5\linewidth]{gfx/overlay_cylinder_submerged.svg}%
}%
% % \hfil%
\subfloat[Adapted template. Template simulated with adapted parameters. Good fit in both highlight and shadow segments.\label{overlay_cylinder_adaptive}]{%
\graphicsAI[width=.5\linewidth]{gfx/overlay_cylinder_submerged_adaptive.svg}%
}%
\subfloat[][...]{hmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm}
% \parbox{1cm}{HMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMmmmmmmmmmmmmmmmmmmmm}
% \hfill
% 
% % \newline
% \raggedright
% \mbox{\parbox{1cm}{\small\centering
% HMmmmmmmmmmmmmmmmmmm mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm
