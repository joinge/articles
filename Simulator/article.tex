...
\graphicsAI[drawing,width=.5\linewidth]{gfx/overlay_cylinder_submerged.svg}\label{overlay_cylinder}%
}%
\hfil%
...
}\caption[LoF entry]{Segmented simulation image overlaid the segmented SAS image. Segmentation overlay color description:\parbox{1cm}{\small\centering 1}}%
% % \hfill
