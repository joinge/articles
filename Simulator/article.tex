...
The next step is to scale, orient and position the objects in the scene, and finally project this scene onto an image plane. This is achieved by applying a set of transformations to each vertex in the model. In OpenGL, the set of transformations are usually formalized as
\begin{align*}
...
dy &= \\
dz &= \\
\phi_x &= \arctan\left(\frac{y_\text{mean}}{x_\text{mean}}\right)
\end{align*}
