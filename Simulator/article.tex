...
\newcommand\step[1]{\tikz[baseline=(char.base)]{%
            \node[shape=circle,draw,color=Green,shade,top color=black!5!white,bottom color=black!15!white,inner sep=.75pt] (char) {\color{Green}#1};}}
...
\colorlet{tableheadcolor}{tabBlue}
