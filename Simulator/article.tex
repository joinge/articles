...
\IEEEPARstart{P}{erhaps} of the greatest visions of science is to create intelligent machines. The potential seems immense and perhaps only limited by our imagination. If we , and is perhaps This is especially true for devices designed to sense and act without aid, such as autonomous underwater vehicles (AUVs). The potential here seems only limited by our imagination. When an AUV equipped with a sonar encounter an interesting object, it would be very beneficial if adapted its behavior to examine the object further. This is challenging as it would need to learn in what ways the interesting objects differ from the background, i.e. it relies on previous knowledge. It would also need to process this information is near real-time to act in an efficient manner.
