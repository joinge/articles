...
\graphicsAI[width=.5\linewidth]{gfx/scene_coordinate_system.svg}%
...
\begin{figure*}[t]\centering%
\graphicsAI[drawing,width=.5\linewidth]{gfx/simulator.svg}%
\caption{Simulator concept.}\label{buildup}%
\end{figure*}


One of the major shortcomings of autonomous underwater vehicles (AUVs) is their lack of intelligence. When encountering an interesting object, an AUV mounted with a sonar imaging system should be able to tell that this object might be worth closer examination, and act accordingly. This is challenging as what we deem as interesting is often something that stand out form the background, i.e. it relies on previous knowledge. It would also need to process this information is near real-time to act in an efficient manner.
