...
\definecolor{cDarkText}{HTML}{ff662f}
\definecolor{cBrightText}{HTML}{3492c2}
% \definecolor{cBrightText}{HTML}{2492c2}
% \definecolor{cDarkArrow}{HTML}{ff662f}
% \definecolor{cBrightArrow}{HTML}{3492c2}
\colorlet{cDarkArrow}{gray}
\colorlet{cBrightArrow}{gray}

\newcommand\supcarry[1]{{\color{cBrightText}#1}}
\newcommand\subcarry[1]{{\color{cDarkText}#1}}
