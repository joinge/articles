...
\vspace{-5pt}
\begin{itemize}
\item GPUs are well suited to accelerate algorithms such as the MVDR beamformer
\item Our GPU implementation of the MVDR beamformer
\begin{itemize}
\item fully supports active sonar systems,
\item easily outperforms CPU implementations, and
\item runs fast enough to support realtime sectorscan imaging.
\end{itemize}
\end{itemize}
\vfill
