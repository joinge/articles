...
\subsection{Beamforming - Basic principle}
...
\subsection{Adaptive Beamformers}
...
\item Maybe Graphics Processing Units (GPUs) are better suited for the purpose?
\end{itemize}
% 
...
\vspace{-5pt}
\begin{figure}[H]
\begin{narrow}{-1cm}{-1cm}\centering
\graphicsAI<1>[width=0.85\linewidth]{gfx/plot_holmengraa_L19_Navg1.svg}%{../Docs/GeiloSrc/Figs/das.pdf}
\end{narrow}
\end{figure}
\vspace{-10pt}
\begin{itemize}
\item MVDR $\Rightarrow$ improved edge definition and noise suppression.
\end{itemize}
\end{frame}
...
\graphicsAI<1>[drawing,width=0.7\linewidth]{gfx/benchmark.svg}
\end{figure}
\vspace{-10pt}
\begin{itemize}
...
\vspace{-10pt}
\begin{itemize}
\item Realtime sectorscan imaging possible for several configurations.
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Thanks to The Norwegian Defence Research Establishment (FFI) and Kongsberg Maritime for providing us with data, and
\item to nVidia for providing us their unofficial batch solver
\end{itemize}
\end{frame}
}
