...
We have tested the \gls{CUDA} implementation of the \gls{MVDR} beamformer on experimental dat from $M=32$ element Kongsberg Maritime HISAS1030 sonar~\cite{Hansen2009}. 
...
\begin{figure}[!t]
\centering
\includegraphics{gfx/benchmark.png}
\caption{Capon benchmarks.}
\label{fig_sim}
\end{figure}
