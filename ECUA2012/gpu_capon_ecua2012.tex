...
An active sonar imaging system usually transmits encoded signals signals towards a surface interest, and record the resulting reflections using an array of receivers. This is allows the receiver outputs to be coherently combined in the post-processing to focus on specific points in the image. The combination process involves assigning suitable delays and weights to the array's channels, and is usually referred to as beamforming.
...
test system was a quad-core Intel Xeon E5620, 64Gb of \gls{RAM}, and an nVidia Quadro 6000 card. This is a \gls{GPU} with 448 \gls{CUDA} cores and 6Gb of onboard \gls{RAM}, capable of roughly 1Tflops. 
