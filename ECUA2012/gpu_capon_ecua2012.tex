...
An active sonar imaging system usually transmits encoded signals signals towards a surface interest, and record the resulting reflections using receiver arrays. The receiver outputs may then be coherently combined in the post-processing to focus on a point in the image. This process is called beamforming, and the combination process involves assigning suitable delays and weights to the array's channels.
