...
\end{align}
The \gls{MVDR} beamformer \cite{Capon1969} finds the set of weights that minimizes the output power $z[n]$, while ensuring unity gain in the look direction. Assuming predelayed data, the solution to this optimization problem is given as
\begin{gather*}
