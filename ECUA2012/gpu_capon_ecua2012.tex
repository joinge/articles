...
To test the runtime speed of our \gls{GPU} implementation of \gls{MVDR}, we have compared it to an optimized single thread C and Matlab implementation (\Fig{benchmarks}). For this test we used a 55\,kpixels sectorscan image. The test system was a quad-core Intel Xeon E5620, with 64Gb of \gls{RAM}, and an nVidia Quadro 6000 card. This is a \gls{GPU} with 448 \gls{CUDA} cores and 6Gb of onboard \gls{RAM}, capable of roughly 1Tflops.
