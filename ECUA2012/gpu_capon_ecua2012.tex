...
The \gls{MVDR} beamformer is an algorithm well suited for implementation on a \gls{GPU}. Each pixels in the image can be processed independently, and the various steps within each pixel . 
