...
If the HISAS1030 was attached to a platform moving at 1.8m/s, for which the maximum range is 250\,m~\cite{Hansen2010}, the pulse repetition frequency could be set to 3\,Hz. Then the throughput required for creating critically sampled 32-beam sectorscan images in realtime would be roughly 1\,Mpixels/s. This is something our \gls{GPU} implementation could handle alone, leaving the \gls{CPU} free to take on other assignments.
