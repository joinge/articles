...
The good news is that this step can greatly benefit from both arithmetic optimizations and parallel computing power. By carefully evaluating (\ref{spatialR}) we can see that:
\begin{itemize}
\item 
\end{itemize}
