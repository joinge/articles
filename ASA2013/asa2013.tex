...
\begin{abstract}
The MVDR adaptive beamformer has lately been shown to improve image quality in active sonar systems, but relies on the estimation and inversion of a spatial covariance for each image pixel. This translates to a computational complexity that is cubic with number of channels.
