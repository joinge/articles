...
In terms of computational complexity the diagonal loading factor is negligible, and will therefore be ignored from now on. Now let $x_l[n]$ represent the datavector from subarray $l$\todo{replace with with a drawing?},
\begin{gather}
