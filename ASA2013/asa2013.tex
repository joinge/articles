...
\end{figure}
The MVDR beamformer target this limitation by computing a set of weights for each pixel that to better fit the dynamic nature of the incoming wavefield. It computes the set of weights that minimizes the noise and signal power accumulated by the array, but with the constraint of unity gain for signal coming from the pixel of interest. When the data is delayed this is formulated as follows:
\begin{gather}
