...
{\Large Design Suggestion} v2\\[0.2cm]
{\itshape for a}\\[0.2cm]
...
In each of these cases the simulator takes a seafloor and target model as input, and generates a simulated sonar image. 
