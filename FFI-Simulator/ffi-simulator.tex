...
As detailed below, in this revision we have decided to opt for slightly more flexibile design to better be able to handle effects such as geometric layover.
...
\subsection{Geometrical Layover}
